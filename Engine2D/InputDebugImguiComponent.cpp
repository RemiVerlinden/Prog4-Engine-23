...
#pragma region BOILERPLATE
	...
	void engine::Input::InputDebugImguiComponent::Initialize()
	{
		EventSubscribe(OnDeath);
	}

	void engine::Input::InputDebugImguiComponent::DrawUI(UpdateContext& /*context*/)
	{
	...
	void engine::Input::InputDebugImguiComponent::DrawIsDeviceConnectedWindow()
	{
		...
		{
			EventManager::GetInstance().SendEvent(engine::OnDeathEvent{"Player1"});
		}
	...
	void engine::Input::InputDebugImguiComponent::DrawDebugGamepadInputVisualisationWindow()
	{
		static auto& inputSystem = Input::InputSystem::GetInstance();
