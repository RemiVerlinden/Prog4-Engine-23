...
namespace engine::Input
{
	...
	class engine::Input::InputStateGamepad::InputStateGamepadImpl
	{
	public:
...
//-------------------------------------------------------------------------
	...
	class engine::Input::InputDeviceGamepad::InputDeviceGamepadImpl
	{
	public:
...
//-------------------------------------------------------------------------
	...
	glm::vec2 engine::Input::InputStateGamepad::GetLeftAnalogStickValue() const
	{
		return m_pImpl->GetLeftAnalogStickValue();
	}

	const glm::vec2* engine::Input::InputStateGamepad::GetAnalogStickFilteredPtr(bool rightStick) const
	{
		return m_pImpl->GetAnalogStickFilteredPtr(rightStick);
	}

	glm::vec2 engine::Input::InputStateGamepad::GetRightAnalogStickValue() const
	{
		return m_pImpl->GetRightAnalogStickValue();
	}

	float engine::Input::InputStateGamepad::GetLeftTriggerValue() const
	{
		return m_pImpl->GetLeftTriggerValue();
	}

	float engine::Input::InputStateGamepad::GetRightTriggerValue() const
	{
		return m_pImpl->GetRightTriggerValue();
	}

	glm::vec2 engine::Input::InputStateGamepad::GetLeftAnalogStickRawValue() const
	{
		return m_pImpl->GetLeftAnalogStickRawValue();
	}

	glm::vec2 engine::Input::InputStateGamepad::GetRightAnalogStickRawValue() const
	{
		return m_pImpl->GetRightAnalogStickRawValue();
	}

	float engine::Input::InputStateGamepad::GetLeftTriggerRawValue() const
	{
		return m_pImpl->GetLeftTriggerRawValue();
	}

	float engine::Input::InputStateGamepad::GetRightTriggerRawValue() const
	{
		return m_pImpl->GetRightTriggerRawValue();
	}

	bool engine::Input::InputStateGamepad::WasPressed(deviceButton button) const
	{
		return m_pImpl->WasPressed(button);
	}

	bool engine::Input::InputStateGamepad::WasReleased(deviceButton button) const
	{
		return m_pImpl->WasReleased(button);
	}

	bool engine::Input::InputStateGamepad::IsHeldDown(deviceButton button) const
	{
		return m_pImpl->IsHeldDown(button);
	}

	bool engine::Input::InputStateGamepad::IsHeldDown(int button) const
	{
		return m_pImpl->IsHeldDown(button);
	}

	bool engine::Input::InputStateGamepad::IsConnected() const
	{
		return m_pImpl->IsConnected();
	}

	void engine::Input::InputStateGamepad::SetConnection(bool connected) const
	{
		m_pImpl->SetConnection(connected);
	}

	int engine::Input::InputStateGamepad::GetGamepadButton(deviceButton button) const
	{
