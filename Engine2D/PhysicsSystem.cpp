...
//}
//
//bool engine::PhysicsSystem::CheckLevelCollision(ColliderComponent* pCollider) const
//{
//    assert(pCollider && "ColliderComponent pointer is null!");
...
//}
//
//void engine::PhysicsSystem::AddCollider(ColliderComponent* pCollider)
//{
//    assert(pCollider && "ColliderComponent pointer is null!");
//    m_pColliders.emplace_back(pCollider);
//}
//
//void engine::PhysicsSystem::AddCollider(GameObject* pObject)
//{
//    assert(pObject && "GameObject pointer is null!");
//    std::vector<ColliderComponent*> colliders{pObject->GetAllComponents<ColliderComponent>()};
//    for (ColliderComponent* pCollider : colliders)
...
//}
//
//void engine::PhysicsSystem::RemoveCollider(ColliderComponent* pCollider)
//{
//    assert(pCollider && "ColliderComponent pointer is null!");
//    std::erase(m_pColliders, pCollider);
//}
//
//void engine::PhysicsSystem::RemoveCollider(GameObject* pObject)
//{
//    assert(pObject && "GameObject pointer is null!");
//    std::vector<ColliderComponent*> colliders{pObject->GetAllComponents<ColliderComponent>()};
//
...
bool engine::PhysicsSystem::CheckCollisionAABB(const Box& a, const Box& b) const
{
...
std::pair<bool, glm::vec2> engine::PhysicsSystem::CheckCollisionCircleVsBox(const Box& b, const Circle& c) const
{
