...
void engine::TrashTheCacheComponent::Initialize()
{
}

void engine::TrashTheCacheComponent::DrawUI(UpdateContext& /*context*/)
{
...
void engine::TrashTheCacheComponent::DrawImguiExercise1Window()
{
	// Set window size
...
void engine::TrashTheCacheComponent::DrawImguiExercise2Window()
{
	// Set window size
	static ImVec2 windowSize = ImVec2(300, 300);
	ImGui::SetNextWindowSize(windowSize, ImGuiCond_Once);
...
void engine::TrashTheCacheComponent::TimeGameObject(InputTimingParameters input)
{
	using namespace std::chrono;
