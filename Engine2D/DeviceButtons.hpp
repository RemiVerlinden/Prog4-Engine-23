...
namespace engine::Input
{
	...
	enum ControllerButton : uint32_t
	{
		...
		SYSTEM_0				= BIT(4),
		SYSTEM_1				= BIT(5),
		THUMBSTICK_LEFT_DOWN	= BIT(6),
		THUMBSTICK_RIGHT_DOWN	= BIT(7),
		SHOULDER_LEFT			= BIT(8),
		SHOULDER_RIGHT			= BIT(9),
		THUMBSTICK_LEFT_MOVE	= BIT(10),
		THUMBSTICK_RIGHT_MOVE	= BIT(11),
		BUTTON_A				= BIT(12),
		BUTTON_B				= BIT(13),
		BUTTON_X				= BIT(14),
		BUTTON_Y				= BIT(15),
		TRIGGER_LEFT			= BIT(16),
		TRIGGER_RIGHT			= BIT(17)
	};
#pragma region ControllerButton operator overloads
	...
	inline ControllerButton operator~(ControllerButton a)
	{
		return static_cast<ControllerButton>(~static_cast<int>(a));
	}
...
#pragma region MouseButton operator overloads
	...
	{
		return static_cast<MouseButton>(~static_cast<int>(a));
	}
